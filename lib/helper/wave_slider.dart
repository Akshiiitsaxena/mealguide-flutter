...
import 'package:mealguide/helper/wave_painter.dart';
...
class WaveSliderState extends State<WaveSlider>
  ...
  late WaveSliderController slideController;

  @override
  void initState() {
    super.initState();
    _sliderWidth = widget.sliderWidth;
    _dragPosition = _sliderWidth / 2;
    print(_dragPosition);
    slideController = WaveSliderController(vsync: this)
  ...
  void _onDragStart(BuildContext context, DragStartDetails start) {
    ...
    slideController.setStateToStart();
  ...
  void _onDragUpdate(BuildContext context, DragUpdateDetails update) {
    ...
    slideController.setStateToSliding();
    _updateDragPosition(localOffset);
    _handleChanged(_dragPercentage);
  }

  void _onDragEnd(BuildContext context, DragEndDetails end) {
    slideController.setStateToStopping();
    setState(() {});
            ...
            child: Container(
              ...
              child: CustomPaint(
                painter: WavePainter(
                  ...
                  sliderState: slideController.state,
                  animationProgress: slideController.progress,
